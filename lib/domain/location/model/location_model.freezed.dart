...
mixin _$LocationModel {
 ...
 String? get countryName; String? get stateName; String? get cityName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocationModel&&(identical(other.countryName, countryName) || other.countryName == countryName)&&(identical(other.stateName, stateName) || other.stateName == stateName)&&(identical(other.cityName, cityName) || other.cityName == cityName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,countryName,stateName,cityName);

@override
String toString() {
  return 'LocationModel(countryName: $countryName, stateName: $stateName, cityName: $cityName)';
}
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? countryName = freezed,Object? stateName = freezed,Object? cityName = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? countryName,  String? stateName,  String? cityName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.countryName,_that.stateName,_that.cityName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? countryName,  String? stateName,  String? cityName)  $default,) {final _that = this;
switch (_that) {
case _LocationModel():
return $default(_that.countryName,_that.stateName,_that.cityName);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? countryName,  String? stateName,  String? cityName)?  $default,) {final _that = this;
switch (_that) {
case _LocationModel() when $default != null:
return $default(_that.countryName,_that.stateName,_that.cityName);case _:
  return null;
...
class _LocationModel implements LocationModel {
  const _LocationModel({this.countryName, this.stateName, this.cityName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LocationModel&&(identical(other.countryName, countryName) || other.countryName == countryName)&&(identical(other.stateName, stateName) || other.stateName == stateName)&&(identical(other.cityName, cityName) || other.cityName == cityName));
}
...
/// Create a copy of LocationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? countryName = freezed,Object? stateName = freezed,Object? cityName = freezed,}) {
